...
contract ENSRegistry is ENS {
    ...
    modifier authorised(bytes32 node) {
        ...
        require(_owner == msg.sender || operators[_owner][msg.sender], "must be ens owner");
        _;
    }
    ...
    function setSubnodeRecord(
        ...
        bytes32 _subnode = setSubnodeOwner(_node, _label, _owner);
        _setResolverAndTTL(_subnode, _resolver, _ttl);
    }
