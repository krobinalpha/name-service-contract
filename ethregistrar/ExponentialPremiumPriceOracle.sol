...
contract ExponentialPremiumPriceOracle is StablePriceOracle {
    ...
    uint256 constant bit3 = 999957694548431104; // 0.5 ^ 2/(1 << 16) * (10 ** 18)
    ...
    modifier onlyOwner() {
		if (msg.sender!=owner) revert MustbeOwner("PriceOracle", msg.sender);
        _;
    }

    function setBasePrice(uint256[] memory _rentPrices) external onlyOwner {
