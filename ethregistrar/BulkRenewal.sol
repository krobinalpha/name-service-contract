...
contract BulkRenewal is IBulkRenewal {
    // bytes32 private constant ETH_NAMEHASH = 0x93cdeb708b7545dc668eb9280176169d1c33cfd8ed6f04690a0bcc88a93fc4ae; // eth
    bytes32 private ETH_NAMEHASH = 0x534e499aa07054e03937905209ceabfecf5290265f1fc04430cea90ba2847648; // neon

    ENS public immutable ens;

    constructor(ENS _ens, bytes32 _namehash) {
        ens = _ens;
        ETH_NAMEHASH = _namehash;
    }
